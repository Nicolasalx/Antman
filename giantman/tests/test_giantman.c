...
{
    int argc = 2;
    char *argv[] = {"./giantman", "tests/test_file.txt"};
    cr_assert_eq(main_test_giantman(argc, argv), 84);
}
...
{
    int argc = 4;
    char *argv[] = {"./giantman", "tests/test_file.txt", "1", "nothing"};
    cr_assert_eq(main_test_giantman(argc, argv), 84);
}
...
{
    int argc = 3;
    char *argv[] = {"./giantman", "tests/test_file.txt", "4"};
    cr_assert_eq(main_test_giantman(argc, argv), 84);
}
...
{
    int argc = 3;
    char *argv[] = {"./giantman", "tests/test_file_1.txt", "1"};
...
{
    int argc = 3;
    char *argv[] = {"./giantman", "tests/test_file_2.txt", "1"};
    cr_assert_eq(main_test_giantman(argc, argv), 0);
}
